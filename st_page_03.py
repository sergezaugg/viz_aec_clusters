...
with c00:
    with st.container(border=True) : 
        ...
        st.markdown('''       
            ...
            The mp3s were cut in 1.0 seconds pieces and transformed to spectrograms resulting in 6714 long grey-scale images of 128 x 1152 pixels (freq x time).
            ...
            The mp3s were cut in shorter 0.2 seconds pieces and transformed to spectrograms, which gave 60'560 grey-scale mini-images of 128 x 128 pixels (freq x time).
